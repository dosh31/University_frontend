import {Button, Col, Container, Form, Input, CardText, Row} from "reactstrap";
...
const SpecialistsListPage = ({specialists, setSpecialists, isMock, setIsMock}:Props) => {
    ...
    const fetchSpecialists = async () => {
        try {
            ...
            const response = await fetch(`${env.VITE_API_URL}/api/specialists/?specialist_name=${specialist_name.toLowerCase()}`)
