        ...
        <header>
            <Navbar className="p-3" expand="lg">
                <Container className="p-0">
                  ...
                  <span className="ms-2">Заявки на специалистов ГУИМЦ</span>
                </NavLink>
                            </NavbarBrand>
                        </Col>
                        ...
                        <Collapse id="responsive-navbar-nav" navbar isOpen={!collapsed}>
                            <Nav className="mr-auto fs-5 d-flex flex-grow-1 justify-content-end align-items-center" onClick={hideMenu} navbar>
                                <NavItem>
                                    <NavLink tag={RRNavLink} to={is_superuser ? "/specialists-table/": "/specialists/"}>
                                        Специалисты
                                    </NavLink>
                                </NavItem>
                                {is_authenticated ?
                                    <>
                                        <NavItem>
                                            <NavLink tag={RRNavLink} to="/lectures/">
                                                Лекции
                                            </NavLink>
                                        </NavItem>
                                        <NavItem>
