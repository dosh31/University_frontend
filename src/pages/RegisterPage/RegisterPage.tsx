...
const RegisterPage = () => {
    ...
    const handleSubmit = async (e: React.SyntheticEvent<HTMLFormElement> ) => {
        ...
        const nameDate = e.currentTarget.elements[0] as HTMLInputElement
        const emailDate = e.currentTarget.elements[1] as HTMLInputElement
        const passwordDate = e.currentTarget.elements[2] as HTMLInputElement

        const data = {
            username: nameDate.value,
