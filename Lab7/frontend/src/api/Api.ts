...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  lectures = {
     ...
     * @secure
     */
    lecturesUpdateStatusAdminUpdate: (lectureId: string, params: RequestParams = {}) =>
      this.request<void, any>({
  ...
  specialists = {
     ...
     * @secure
     */
    specialistsCreateCreate: (params: RequestParams = {}) =>
      this.request<void, any>({
     ...
     * @secure
     */
    specialistsUpdateUpdate: (specialistId: string, params: RequestParams = {}) =>
      this.request<void, any>({
     ...
     * @secure
     */
    specialistsUpdateImageCreate: (specialistId: string, params: RequestParams = {}) =>
      this.request<void, any>({
